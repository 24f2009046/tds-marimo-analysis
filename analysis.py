...
# y depends on x and freq_slider, it will update reactively when freq_slider changes
y = np.sin(freq_slider * x)

# Cell 3: Plot showing the relationship between variables x and y
plt.plot(x, y)
plt.title(f"Sine wave with frequency = {freq_slider}")
plt.xlabel("x")
